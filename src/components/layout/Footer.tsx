      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full px-5 sm:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 max-w-[600px] gap-8 pb-16 md:pb-24">
          ...
          <div className="flex flex-col gap-3 col-span-2 sm:col-span-1">
            ...
            <a 
              ...
              className="font-sans text-[13px] font-semibold text-[#D4C5B9] hover:underline break-words"
            >
              hello@aura-atelier.com
            </a>
            <p className="font-sans text-[11px] text-white/60 leading-relaxed pt-1">
              740 Atelier Way, Zurich & San Francisco
            </p>
          </div>
        ...
        <div className="relative w-full text-center leading-[0.78] -mb-3 sm:-mb-5 md:-mb-6 select-none pointer-events-none overflow-hidden">
          <motion.span
            ...
            className="font-serif text-[clamp(80px,19vw,270px)] font-bold text-[#F9F7F2]/35 uppercase inline-block"
          >
            AURA
          </motion.span>
        </div>
